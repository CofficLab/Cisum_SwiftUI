...
/// 极光 说明书 —— 章节式文档。
struct ThemeAuroraPluginManualView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 22) {
            ManualHeader(title: String(localized: "Aurora", bundle: .module), subtitle: "User Manual")

            ManualSectionHeader(number: 1, title: String(localized: "Overview", bundle: .module))
            Text("A deep blue-purple gradient, like an aurora in the night sky")
                .font(.appBody)
            ...
            ManualBulletList(items: [
                .init(String(localized: "Theme Appearance: the overall palette and texture of the Aurora theme.", bundle: .module)),
