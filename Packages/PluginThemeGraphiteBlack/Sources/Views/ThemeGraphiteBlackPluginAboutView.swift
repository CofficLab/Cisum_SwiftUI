...
/// 石墨黑 关于视图 —— Landing 落地页。
struct ThemeGraphiteBlackPluginAboutView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 22) {
            LandingHero(
                ...
                tagline: String(localized: "A low-key, restrained dark theme", bundle: .module),
                chips: [String(localized: "Graphite Black", bundle: .module)],
                metrics: [
            ...
            LandingSection(title: String(localized: "Core Capabilities", bundle: .module), icon: "sparkles") {
                ...
                .init(icon: "paintpalette", tint: theme.primary, title: String(localized: "Theme Appearance", bundle: .module), description: String(localized: "The overall palette and texture of the Graphite Black theme.", bundle: .module)),
