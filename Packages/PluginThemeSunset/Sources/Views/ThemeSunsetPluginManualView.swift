...
/// 日落 说明书 —— 章节式文档。
struct ThemeSunsetPluginManualView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 22) {
            ManualHeader(title: String(localized: "Sunset", bundle: .module), subtitle: "User Manual")

            ManualSectionHeader(number: 1, title: String(localized: "Overview", bundle: .module))
            Text("A warm sunset-orange gradient theme")
                .font(.appBody)
            ...
            ManualBulletList(items: [
                .init(String(localized: "Theme Appearance: the overall palette and texture of the Sunset theme.", bundle: .module)),
