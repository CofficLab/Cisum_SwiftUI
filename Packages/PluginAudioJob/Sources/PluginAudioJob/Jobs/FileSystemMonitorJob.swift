...
public final class FileSystemMonitorJob: AudioJob, @unchecked Sendable {
    ...
    public nonisolated let name = String(localized: "File System Monitor", table: "Audio-Job")
    public nonisolated let description = String(localized: "Monitor audio file system changes and sync to database", table: "Audio-Job")
