...
extension DBSynced {
    public func insertDeviceData(deviceId: String) {
    ...
    public func saveDeviceData(uuid: String, audioCount: Int) {
    ...
    public func deleteDevice(_ deviceData: DeviceData) {
    ...
    public func find(_ uuid: String) -> DeviceData? {
        do {
    ...
    public func allDevices() -> [DeviceData] {
        do {
