...
struct ThemeOceanPluginManualView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 22) {
            ManualHeader(title: String(localized: "Ocean", bundle: .module), subtitle: "User Manual")

            ManualSectionHeader(number: 1, title: String(localized: "Overview", bundle: .module))
            Text("A fresh ocean-blue theme")
                .font(.appBody)
            ...
            ManualBulletList(items: [
                .init(String(localized: "Theme Appearance: the overall palette and texture of the Ocean theme.", bundle: .module)),
