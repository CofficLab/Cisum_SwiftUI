...
/// 日光银 说明书 —— 章节式文档。
struct ThemeDaylightSilverPluginManualView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 22) {
            ManualHeader(title: String(localized: "Daylight Silver", bundle: .module), subtitle: "User Manual")

            ManualSectionHeader(number: 1, title: String(localized: "Overview", bundle: .module))
            Text("A bright, soft silver-toned theme")
                .font(.appBody)
            ...
            ManualBulletList(items: [
                .init(String(localized: "Theme Appearance: the overall palette and texture of the Daylight Silver theme.", bundle: .module)),
