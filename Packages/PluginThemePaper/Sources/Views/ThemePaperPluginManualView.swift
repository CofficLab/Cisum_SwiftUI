...
/// 纸张 说明书 —— 章节式文档。
struct ThemePaperPluginManualView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 22) {
            ManualHeader(title: String(localized: "Paper", bundle: .module), subtitle: "User Manual")

            ManualSectionHeader(number: 1, title: String(localized: "Overview", bundle: .module))
            Text("A warm paper-textured theme")
                .font(.appBody)
            ...
            ManualBulletList(items: [
                .init(String(localized: "Theme Appearance: the overall palette and texture of the Paper theme.", bundle: .module)),
