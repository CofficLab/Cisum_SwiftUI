...
/// Cisum 经典 关于视图 —— Landing 落地页。
struct ThemeCisumPluginAboutView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 22) {
            LandingHero(
                ...
                tagline: String(localized: "Cisum's default appearance theme", bundle: .module),
                chips: [String(localized: "Cisum Classic", bundle: .module)],
                metrics: [
            ...
            LandingSection(title: String(localized: "Core Capabilities", bundle: .module), icon: "sparkles") {
                ...
                .init(icon: "paintpalette", tint: theme.primary, title: String(localized: "Theme Appearance", bundle: .module), description: String(localized: "The overall palette and texture of the Cisum Classic theme.", bundle: .module)),
