public enum BookPluginInfo {
    ...
    public static let title = String(localized: "Audiobook", table: "Book", bundle: .module)
    public static let description = String(localized: "Audiobook playback", table: "Book", bundle: .module)
