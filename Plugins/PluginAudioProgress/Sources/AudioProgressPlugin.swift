...
public actor AudioProgressPlugin: SuperPlugin, SuperLog {
    ...
    public nonisolated var title: String { String(localized: String.LocalizationValue(AudioProgressPluginInfo.titleKey), bundle: .module) }
    public nonisolated var description: String { String(localized: String.LocalizationValue(AudioProgressPluginInfo.descriptionKey), bundle: .module) }
